           ...
           {!loading && (
             ...
             <div className="col-md-12 d-flex justify-content-center align-items-center">
                 <div className="p-5 wow fadeInUp" data-wow-delay="0.2s">
                     ...
                     <h1 className="text-white mb-4">Login Here</h1>
                     <form>
                         ...
                         <div className="row g-3 mt-2">
                            <div className="col-md-4">
                                <div className="form-floating">
                                    <div class="bg-white py-2 rounded-pill text-center">Google</div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="form-floating">
                                    <div class="bg-white py-2 rounded-pill text-center">Fackbook</div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="form-floating">
                                    <div class="bg-white py-2 rounded-pill text-center">Twitter</div>
                                </div>
                            </div>
                         </div>
                     </form>
